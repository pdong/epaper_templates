...
export default {
  ...
  "power.sleep_override_value": {
    "ui:help":
      "The value Sleep Override Pin must be held to in order to suspend deep sleep.",
  },
  "mqtt.password": {
    "ui:widget": "password",
  },
  ...
  "hardware.ss_pin_override": {
    ...
    "ui:help": (
      <>
        <div>
          SPI bus to use. HSPI uses GPIOs 12, 14, 15. VSPI uses 5, 18, 19. See
          README for more details.
        </div>
        <div>
          <MemoizedFontAwesomeIcon
            icon={faExclamationTriangle}
            className="text-warning fa-fw mr-1"
          />
  ...
  "mqtt.client_status_topic": {
    "ui:help":
      "If provided, MQTT birth and LWT messages will be published to this topic.",
  },
};
